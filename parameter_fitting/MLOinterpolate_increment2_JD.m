...
function [annincMLOSPO,dpCO2a,MLOSPOiceinterp] = MLOinterpolate_increment2_JD(ts,start_year,end_year)
...
j = length(MLOSPOiceinterp);
dpCO2a(:,1) = MLOSPOiceinterp(i:j,1); 
dpCO2a(:,2) = MLOSPOiceinterp(i:j,2)-MLOSPOiceinterp(i,2);