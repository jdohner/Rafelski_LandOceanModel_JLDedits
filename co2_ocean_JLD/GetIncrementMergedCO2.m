% file GetIncrementMergedCO2.m
% formerly "MLOinterpolate_increment2.m"
%
...
function [dtdelpCO2a,dpCO2a,year,dt,MLOSPOice_interp] = GetIncrementMergedCO2(timeStepPerYear,start_year,end_year)
