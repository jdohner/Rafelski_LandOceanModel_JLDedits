...
%
% brief LandUptakeModel_Driver.m is the driver code for the land model.  
...
%
% TODO -finish heading
% - ask Andre about linter for atom, how to use atom for MATLAB code
%
% changes by LR
...
start_year = 1850;
end_year = 2009+(7/12); % can I define this by data(end,1) so can vary? JLD
