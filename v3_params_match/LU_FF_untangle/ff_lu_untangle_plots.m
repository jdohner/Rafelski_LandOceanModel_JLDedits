...
title('Total Emissions by Nation','FontSize', 24);
% legend('China','USA','Russia','Western Europe & Japan',...
%     'Everything else');
ylabel('GtC/year','FontSize', 14);
set(gca,'FontSize',14)
...
% subplot(3,1,2)
% plot(WE_japan_total(:,1),d2*WE_japan_total(:,2),'.',...
%     everythingElse(:,1),d2*everythingElse(:,2),'.');
% legend('Western Europe & Japan','Everything else',...
%     'location','northwest')
% grid
...
legend({'China','USA','Russia','Western Europe & Japan',...
    ...
    'Rafelski low'},'location','northwest','FontSize', 14);
...
plot(china_totalann(:,1),d2*china_totalann(:,2),...
    ...
    WE_japan_total(:,1),d2*WE_japan_total(:,2),...
    everythingElse(:,1),d2*everythingElse(:,2),'--');
title('Total Emissions by Nation','FontSize', 18);
line([1840,2020],[0,0],'linestyle','--');
legend({'China','USA','Russia','Western Europe & Japan',....
    'All other emissions'},'location','northwest','FontSize', 14)
xlabel('Year','FontSize', 14)
set(gca,'FontSize',14)
ylabel('GtC/yr','FontSize', 14)
set(gca,'FontSize',14)
xlim([1840 2020])
ylim([0 6])
grid
...
line([1840,2020],[0,0],'linestyle','--');
if tempDep == 1
    title('Temp-dependent: Model Residual Fluxes (Obs-Modeled)','FontSize', 18);
else
    title('Temp-independent: Model Residual Fluxes (Obs-Modeled)','FontSize', 18);
end
...
plot(LUhoughmo(:,1),LUhoughmo(:,2),LUhansismo(:,1),LUhansismo(:,2),...
    LUgcpmo(:,1),LUgcpmo(:,2),LU(:,1),LU(:,2),LUex(:,1),LUex(:,2))
line([1840,2020],[0,0],'linestyle','--');
title('Land Use Records','FontSize', 18);
...
title('Difference between T-dep and T-indep modeled CO_2 using Houghton Land Use',...
    'FontSize', 18)
legend({'Temp-dep - Temp-indep Predicted CO_2'},'FontSize', 14)
xlabel('Year','FontSize', 14)
set(gca,'FontSize',14)
ylabel('GtC','FontSize', 14)
set(gca,'FontSize',14)
